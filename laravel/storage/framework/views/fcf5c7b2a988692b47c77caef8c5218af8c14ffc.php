...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1>All Deals (<?php echo e($viewType === 'list' ? $deals->total() : collect($dealsByStatus)->flatten()->count()); ?>)</h1>
        <div class="d-flex align-items-center">
            ...
            <div class="d-flex me-3">
                <a href="<?php echo e(route('deal.index', ['view' => 'list'])); ?>" class="btn btn-sm <?php echo e($viewType === 'list' ? 'btn-primary' : 'btn-outline-secondary'); ?> me-1">
                    <i class="bi bi-list-ul"></i> List
                </a>
                <a href="<?php echo e(route('deal.index', ['view' => 'kanban'])); ?>" class="btn btn-sm <?php echo e($viewType === 'kanban' ? 'btn-primary' : 'btn-outline-secondary'); ?>">
                    <i class="bi bi-kanban"></i> Pipeline
                </a>
            </div>
            <form action="<?php echo e(route('deal.index')); ?>" method="GET" class="d-flex">
    ...
    <?php if($viewType === 'list'): ?>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <a href="<?php echo e(route('customer.show', ['id' => $deal->customer->id])); ?>">
                                <?php echo e($deal->customer->name); ?>

                            </a>
                        </td>
                        <td><?php echo e($deal->title); ?></td>
                        <td>
                            <span class="badge bg-<?php echo e($deal->status === Deal::STATUS_CLOSED ? 'secondary' : 'primary'); ?>">
                                <?php echo e($deal->status); ?>

                            </span>
                        </td>
                        <td><?php echo e($deal->quotes->count()); ?></td>
                        <td><?php echo e($deal->orders->count()); ?></td>
                        <td><?php echo e($deal->created_at->format('d/m/Y')); ?></td>
                        <td class="text-nowrap">
                            <a href="<?php echo e(route('deal.show', ['id' => $deal->id])); ?>" class="btn btn-sm btn-info">View</a>
                            <a href="<?php echo e(route('deal.edit', ['id' => $deal->id])); ?>" class="btn btn-sm btn-warning">Edit</a>
                        </td>
                    </tr>
        ...
        <div class="mt-3">
            <a href="<?php echo e(route('deal.create')); ?>" class="btn btn-primary">Create New Deal</a>
        </div>
    <?php else: ?>
        <!-- Kanban View -->
        <div class="kanban-board">
            <div class="row flex-nowrap overflow-auto pb-3">
                <?php $__currentLoopData = Deal::getStatuses(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-3 col-sm-4" style="min-height: 600px;">
                        <div class="kanban-column card h-100">
                            <div class="card-header d-flex justify-content-between align-items-center kanban-column-header <?php echo e(str_replace(' ', '-', strtolower($status))); ?>-header">
                                <h5 class="mb-0"><?php echo e($status); ?></h5>
                                <span class="badge bg-light text-dark rounded-pill"><?php echo e(count($dealsByStatus[$status])); ?></span>
                            </div>
                            <div class="card-body p-2" data-status="<?php echo e($status); ?>" id="column-<?php echo e(str_replace(' ', '-', strtolower($status))); ?>">
                                <?php $__currentLoopData = $dealsByStatus[$status]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <div class="kanban-item card mb-2" 
                                         ...
                                         style="border-left: 6px solid <?php echo e($borderColor); ?>; transition: all 0.3s ease;"
                                        ...
                                        <div class="card-header p-2 d-flex justify-content-between align-items-center bg-light border-bottom">
                                            <h6 class="mb-0 deal-title fw-bold text-truncate me-1"><?php echo e($deal->title ?? 'Deal #' . $deal->id); ?></h6>
                                            <a href="<?php echo e(route('deal.show', ['id' => $deal->id])); ?>" target="_blank" class="btn btn-sm btn-outline-secondary p-1">
                                        ...
                                        <div class="card-body p-2">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                ...
                                                <div class="d-flex align-items-center flex-grow-1">
                                                    ...
                                                    <div class="customer-details">
                                                        <p class="small mb-0 fw-semibold text-truncate"><?php echo e($deal->customer->name); ?></p>
                                                        <p class="small text-muted mb-0 text-truncate"><?php echo e($deal->customer->business_name); ?></p>
                                                    </div>
                                                </div>
                                                <!-- Quotes count -->
                                                <div class="ms-2">
                                                    <span class="badge bg-info rounded-pill" title="<?php echo e($deal->quotes->count()); ?> Quotes">
                                                        <i class="bi bi-file-text"></i> <?php echo e($deal->quotes->count()); ?>
                                            ...
                                            <div class="deal-dates d-flex justify-content-between border-top pt-1 mt-1">
                                                <span class="small text-muted">
                                                    <i class="bi bi-calendar-plus me-1"></i><?php echo e($deal->created_at->format('d M Y')); ?>

                                                </span>
                                                <?php if($deal->updated_at->gt($deal->created_at)): ?>
                                                    <span class="small text-muted">
                                                        <i class="bi bi-arrow-clockwise me-1"></i><?php echo e($deal->updated_at->diffForHumans(null, true)); ?>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Jonny\Desktop\production\quoting\laravel\resources\views/deal/index.blade.php ENDPATH**/ ?>